...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_johndpope/5e31052937adaaff177bb683eebace1b/execroot/__main__',
    ...
    set([
        '//ProjectManagement:ProjectManagementTests',
        '//App:ios_app',
    ]),
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/johndpope/Library/Application Support/Tulsi/0.20220310.88/Bazel',
